...
const documents = [
  {
    id: 'main.ts',
    title: 'Main entry',
    description: '발표 시작 장면과 기본 작업 흐름을 보여주기 좋은 메인 문서입니다.',
  },
  {
    id: 'auth.ts',
    title: 'Auth flow',
    description: '다른 사용자가 보고 있는 문서를 전환하며 협업 상태를 설명하기 좋은 문서입니다.',
  },
  {
    id: 'presence.ts',
    title: 'Presence sync',
    description: '접속자 정보와 현재 보고 있는 문서가 함께 보이는 데모용 문서입니다.',
  },
    ...
    <main className="app-shell">
      <section className="app-header">
        <div>
          ...
          <p className="subtle">
            접속자 현황, 현재 보고 있는 문서, 전체 화면 발표 흐름까지 한 화면에서 자연스럽게 이어지는 협업 데모입니다.
          </p>
        </div>
      ...
      <section className="overview-grid">
        ...
        <article className="summary-card">
          ...
          <p>문서 전환과 참여자 변화를 함께 보여주면 발표 흐름을 매끄럽게 만들 수 있습니다.</p>
        </article>
      </section>
        ...
        <div className="sidebar-column">
          ...
          <div className="sidebar-card checklist-card">
            ...
            <ul className="checklist">
              ...
              <li>문서를 바꾸면서 오른쪽 참가자 viewing 상태가 함께 변하는지 설명하기</li>
              <li>마지막에 전체 화면으로 전환해 데모를 마무리하기</li>
            </ul>
          </div>
        </div>
      </section>
